...
available blocks: text, headings 1–3, bullet lists, numbered lists, checklists, quotes, code blocks, dividers, and tables. the normal editor changes the current block; source panes insert its markdown syntax. undo restores the slash command. the popup stays within the window and supports reduced motion.
